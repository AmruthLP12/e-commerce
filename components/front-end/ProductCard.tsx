...
const ProductCard = ({ id, img, title, price, category }: propsType) => {
...
<div className="flex justify-center items-center mt-4">
    ...
    <div className="flex gap-2 items-center bg-pink text-white px-4 py-2 cursor-pointer hover:bg-accent" onClick={addProductsToCart}><AiOutlineShoppingCart/> Add To Cart</div>
</div>
